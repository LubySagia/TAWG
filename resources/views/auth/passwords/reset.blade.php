...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
                        ...
                        <div class="kt-login__body">
                            ...
                            <div class="kt-login__form">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form" method="POST" action="{{ route('reset') }}" novalidate="novalidate" id="kt_login_form">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required  placeholder="Mật khẩu mới">
                                        <span class="form-text text-muted">Mật khẩu phải nhiều hơn 6 ký tự</span>
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="kt-login__actions">
                                        <button id="kt_login_signin_submit" class="btn btn-primary btn-elevate kt-login__btn-primary text-right">Đổi mật khẩu</button>
                                    </div>
                                    @if (session('success'))
        ...
        <script src="{{ asset('assets/admin/js/pages/custom/login/login-2.js')}}" type="text/javascript"></script>
